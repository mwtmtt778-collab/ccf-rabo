...
LEFT_DRY_RUN_CANDIDATES = [
    {
        ...
        "approach": Pose6(0.385, 0.038, -0.16, 0.0, 0.0, 0.0),
        "grasp": Pose6(0.385, 0.038, -0.20, 0.0, 0.0, 0.0),
        "lift": Pose6(0.385, 0.038, -0.16, 0.0, 0.0, 0.0),
        "note": "Middle workspace candidate between Nut area and Official Place B.",
    },
    {
        "name": "LEFT_DRY_RUN_CANDIDATE_2",
        "approach": Pose6(0.385, 0.080, -0.16, 0.0, 0.0, 0.0),
        "grasp": Pose6(0.385, 0.080, -0.20, 0.0, 0.0, 0.0),
        "lift": Pose6(0.385, 0.080, -0.16, 0.0, 0.0, 0.0),
        "note": "Nearby backup candidate with larger y.",
    },
    {
        "name": "LEFT_DRY_RUN_CANDIDATE_3",
        "approach": Pose6(0.400, 0.100, -0.16, 0.0, 0.0, 0.0),
        "grasp": Pose6(0.400, 0.100, -0.20, 0.0, 0.0, 0.0),
        "lift": Pose6(0.400, 0.100, -0.16, 0.0, 0.0, 0.0),
        "note": "Nearby backup candidate between Candidate 2 and Place B.",
    },
    {
        "name": "LEFT_DRY_RUN_CANDIDATE_4",
        "approach": Pose6(0.410, 0.120, -0.16, 0.0, 0.0, 0.0),
        "grasp": Pose6(0.410, 0.120, -0.20, 0.0, 0.0, 0.0),
        "lift": Pose6(0.410, 0.120, -0.16, 0.0, 0.0, 0.0),
        "note": "Farthest backup candidate toward Official Place B.",
    },
]
