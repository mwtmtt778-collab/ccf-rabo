...
def run_act_c_only_expert(
    ...
    *,
    ...
    # Minimal path intentionally omits READY_CHECK gates and diagnostics.
    runner.enter("RIGHT_READY")
    runner.pass_state({"path": move_joints_path(runner, right_bundle.right_arm, RIGHT_OBSERVATION_JOINTS, "RIGHT_READY")})
    runner.enter("LEFT_READY")
    runner.pass_state({"path": move_joints_path(runner, left_bundle.left_arm, LEFT_INITIAL_READY_PATH, "LEFT_READY")})
