...
def run():
    ...
    nut_b_positon=[-0.3213+random.uniform(-0.02,0.02),-0.1910+random.uniform(-0.02,0.02),0.2806,0,0,0.5233]
    pose_setter = SetEntityPose(world=WORLD_ID)
    pose_setter.set(
        NUT_B_ID, (nut_b_positon[0],nut_b_positon[1],nut_b_positon[2],nut_b_positon[3],nut_b_positon[4],nut_b_positon[5])
    )
    # ===== 右臂控制 =====
    ...
    # right_arm.move_to(right_arm_position[0]-nut_b_positon[0]+0.06,right_arm_position[1]-nut_b_positon[1]-0.01,-0.1,0,0.8,0)
    right_arm.move_to(right_arm_position[0]-nut_b_positon[0]+0.06,right_arm_position[1]-nut_b_positon[1]-0.01,-0.33,0,0.8,0)
